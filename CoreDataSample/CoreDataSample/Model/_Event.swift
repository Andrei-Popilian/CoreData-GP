...
open class _Event: NSManagedObject {
    ...
    @nonobjc
    class func fetchRequest() -> NSFetchRequest<Event> {
  ...
  // If we need to use Codable we will have to comment this code, 2 convenience or required inits cannot be used
